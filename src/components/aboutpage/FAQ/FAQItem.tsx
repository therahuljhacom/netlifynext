...
//         <>
//             <div className={styles["faq"]}>
//                 <div className={styles["question"]}><div className={styles["question-text"]} onClick={() => { data.handleFunction(data.id) }}>{data.ques}</div>{data.isActive ? <AiOutlineMinus className={styles["plus-icon"]} onClick={() => { data.handleFunction(null) }} /> : <AiOutlinePlus className={styles["plus-icon"]} onClick={() => { data.handleFunction(data.id) }} />}</div>
//                 {data.isActive && <div className={styles["answer"]}>{data.ans}</div>}
//             </div>
//         </>
//     )
// }
